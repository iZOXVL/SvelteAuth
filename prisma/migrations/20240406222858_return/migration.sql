...
INSERT INTO "new_User" ("createdAt", "id", "passwordHash", "roleId", "updatedAt", "userAuthToken", "username") SELECT "createdAt", "id", "passwordHash", "roleId", "updatedAt", "userAuthToken", "username" FROM "User";
DROP TABLE "User";
